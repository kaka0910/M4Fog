...
def create_parser():
    ...
    parser.add_argument('--data_root', default='/groups/lmm2024/home/share/Sat_Pretrain_xmq/OpenSTL-OpenSTL-Lightning/data/')
    # parser.add_argument('--data_root', default='/nas2/data/users/xmq/Prediction/OpenSTL-OpenSTL-Lightning-update/data')
    parser.add_argument('--dataname', '-d', default='mmnist', type=str,
                        choices=['bair', 'mfmnist', 'mmnist', 'mmnist_cifar', 'noisymmnist', 'taxibj', 'human',
                                ...
                                'meteo', 'cloud_tc', 'cloudtc_meteo', 'h8_1w', 'fy4a_3k', 
                                'h8_17x_tc', 'h8_17x_nc', 'h8_17x_tc_comb4',],
