...
from option_h8_sst import Options
...
def main_worker(gpu, ngpus_per_node, argss):
    ...
    # dataset
    train_data = get_segmentation_dataset(args.dataset, root=args.data_root, npz_root=args.npz_root, split='train_all')
    val_data = get_segmentation_dataset(args.dataset, root=args.data_root, npz_root=args.npz_root, split='val_2021')
