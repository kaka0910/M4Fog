...
def get_unet_2output(dataset='cloud', **kwargs):
    # infer number of classes
    from ..datasets import datasets
    model = Unet_2output(in_channels=32, num_classes=2, **kwargs)
    return model

class Unet_2output(nn.Module):
    def __init__(
        self, 
        in_channels=14,
        num_classes=2,
        ...
        super(Unet_2output, self).__init__()
