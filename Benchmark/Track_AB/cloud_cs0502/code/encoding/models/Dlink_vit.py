...
def get_Dlink_vit(dataset='h8', **kwargs):
    # infer number of classes
    from ..datasets import datasets
    model = Dlink_vit(patch_size=16, num_classes=datasets[dataset.lower()].NUM_CLASS, **kwargs)
    return model
...
class Dlink_vit(nn.Module):
    ...
    def __init__(
        ...
        self.finalconv2 = nn.Conv2d(32, 32, 3, 1, 1)
        self.finalrelu2 = nonlinearity
        self.finalconv3 = nn.Conv2d(32, num_classes, 3, 1, 1)
