...
def get_unet_motion_v1(dataset='cloud', **kwargs):
    # infer number of classes
    from ..datasets import datasets
    model = Unet_motion_v1(in_channels=14, num_classes=2, **kwargs)
    return model

class Unet_motion_v1(nn.Module):
    def __init__(
        self, 
        in_channels=14,
        num_classes=2,
        ...
        super(Unet_motion_v1, self).__init__()
        ...
        self.base_size = 256
        self.crop_size = 256
        self.down1 = self.conv_stage(in_channels, 56)
        ...
        self.conv_dist = nn.Conv2d(1, 8, 3, 1, 1)
    ...
    def forward(self, x, y=None):
        ...
        x1 = x[:,:14,:,:]  # image
        conv1_image = self.down1(x1)
        
        conv1_out = torch.concatenate([conv1_image,conv_dist], dim=1)
