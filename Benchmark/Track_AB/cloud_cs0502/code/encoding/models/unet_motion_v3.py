...
def get_unet_motion_v3(dataset='cloud', **kwargs):
    # infer number of classes
    from ..datasets import datasets
    model = Unet_motion_v3(in_channels=16, num_classes=2, **kwargs)
    return model

class Unet_motion_v3(nn.Module):
    def __init__(
        self, 
        in_channels=14,
        num_classes=2,
        ...
        super(Unet_motion_v3, self).__init__()
        ...
        self.base_size = 256
        self.crop_size = 256
        self.down0 = self.conv_stage(1, 32)
