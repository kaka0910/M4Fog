...
def get_s2unet_v7(dataset='cloud', **kwargs):
    # infer number of classes
    from ..datasets import datasets
    model = S2UNet_v7(num_classes=datasets[dataset.lower()].NUM_CLASS, **kwargs)
    return model

class S2UNet_v7(nn.Module):
    def __init__(
        self,
        image_size=256,
        in_channels=16,
