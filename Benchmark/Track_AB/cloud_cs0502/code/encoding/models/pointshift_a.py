...
def get_s2unet_v7a(dataset='cloud', **kwargs):
    # infer number of classes
    from ..datasets import datasets
    model = S2UNet_v7a(num_classes=datasets[dataset.lower()].NUM_CLASS, **kwargs)
    return model

class S2UNet_v7a(nn.Module):
    def __init__(
        self,
        image_size=256,
        in_channels=16,
        ...
        super(S2UNet_v7a, self).__init__()
        self.base_size = 256
        self.crop_size = 256
