...
def get_unet_sigmoid(dataset='h8_sig', criterion_seg=None, **kwargs):
    # infer number of classes
    # from ../../datasets import datasets
    model = Unet_sig(in_channels=16, num_classes=1, criterion_seg=criterion_seg, **kwargs)
    return model

class Unet_sig(nn.Module):
    def __init__(
        self, 
        in_channels,
        num_classes,
        ...
        self.base_size = 1024
        self.crop_size = 1024
        self.down1 = self.conv_stage(img_ch, 64)
