...
class ResT(nn.Module):
    def __init__(self, in_chans=14, num_classes=2, embed_dims=[64, 128, 256, 512],
...
class BANet(nn.Module):
    def __init__(self, criterion_seg, n_classes=2, weight_path=None):
...
def get_BANet(dataset='h8',criterion_seg=None, **kwargs):
    # infer number of classes
    model = BANet(criterion_seg, n_classes=2, **kwargs)
    return model
