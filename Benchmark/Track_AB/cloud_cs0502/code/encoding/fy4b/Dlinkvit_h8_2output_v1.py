...
def get_dlinkvit_h8_2output_v1(dataset='h8', **kwargs):
    # infer number of classes
    # from ..datasets import datasets
    model = Dlink_vit_2output_v1(patch_size=16, num_classes=2, **kwargs)
    return model

class Dlink_vit_2output_v1(nn.Module):
    params = {
    ...
    def __init__(
        ...
        super(Dlink_vit_2output_v1, self).__init__()
        self.base_size = 1024
        self.crop_size = 1024
