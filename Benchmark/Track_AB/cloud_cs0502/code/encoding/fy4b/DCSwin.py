...
def get_DCSwin(dataset='h8',criterion_seg=None, **kwargs):
    # infer number of classes
    # model = DCSwin(criterion_seg=criterion_seg, **kwargs)
    model=dcswin_base(criterion_seg=criterion_seg, pretrained=False,num_classes=2, **kwargs)
    return model
...
def dcswin_base(criterion_seg=None, pretrained=False, num_classes=2, weight_path=None):
