...
def get_dlinkvit_h8_2output(dataset='h8', **kwargs):
    # infer number of classes
    # from ..datasets import datasets
    model = Dlink_vit_2output(patch_size=16, num_classes=2, **kwargs)
    return model

class Dlink_vit_2output(nn.Module):
    params = {
    ...
    def __init__(
        ...
        super(Dlink_vit_2output, self).__init__()
        self.base_size = 1024
        self.crop_size = 1024
        ...
        self.finalconv3_1 = nn.Conv2d(32, num_classes, 3, padding=1)
        self.finalconv3_2 = nn.Conv2d(32, num_classes, 3, padding=1)
    ...
    def forward(self, x, y=None):
        ...
        e1_2, e2_2, e3_2, e4_2 = self.vit_backbone_1(x2)
        ...
        # decoder
        d4 = self.decoder4(e4) + e3_2/2 + e3_1/2
        d3 = self.decoder3(d4) + e2_2/2 + e2_1/2
        d2 = self.decoder2(d3) + e1_2/2 + e1_1/2
        d1 = self.decoder1(d2)
        ...
        out1 = self.finalconv3_1(out)
        out2 = self.finalconv3_2(out)
