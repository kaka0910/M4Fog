...
class LIP(BaseDataset):
    ...
    def __getitem__(self, index):
        ...
        if 'testval' in self.list_path:
            ...
            return torch.from_numpy(image.copy()), torch.from_numpy(label.copy()).long() #, np.array(size), name
        ...
        return image.copy(), torch.from_numpy(label.copy()).long() #, np.array(size), name
