...
class H8Set_2out1(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        # import pdb;
        # pdb.set_trace()
        img_0, img_1, mask = self.loader(id, self.root, self.split, t=2)
...
if __name__ == "__main__":
    a=H8Set_2out1('/groups/lmm2024/home/share/Sat_Pretrain_xmq/Data/H8_Data',"train_all")
