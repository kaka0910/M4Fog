...
def default_loader(id, root, split, t):
    ...
    if t==2:
        ...
        id_index_1 = id.split('_')[-1]
        id_index_0 = str(int(id_index_1)-100).zfill(4)
    elif t==4:
        id_index_1 = id.split('_')[-1]
        if id_index_1[-2:]=='30':
            id_index_0 = str(int(id_index_1)-130).zfill(4)
        else:
            id_index_0 = str(int(id_index_1)-170).zfill(4)
    elif t==5:
        id_index_1 = id.split('_')[-1]
        id_index_0 = str(int(id_index_1)-200).zfill(4)
    ...
    return img_0, img_1, mask
    
class H8Set_Temporal(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        # import pdb;
        # pdb.set_trace()
        img_0, img_1, mask = self.loader(id, self.root, self.split, t=3)
...
if __name__ == "__main__":
    a=H8Set_Temporal('/groups/lmm2024/home/share/Sat_Pretrain_xmq/Data/H8_Data',"train_all")
