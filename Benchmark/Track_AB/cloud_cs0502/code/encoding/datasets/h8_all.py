...
def default_loader(id, root, npz_root, split):
    ...
    return img, mask, sst, cos
    
class H8Set_ALL(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        # 合并img和sst
        combined_img= torch.cat((img, sst, cos),dim=0) #这里的shape应该是（18，1024，1024）
...
if __name__ == "__main__":
    a = H8Set_ALL("/home/ssdk/mmengine/seafog_year_0412/","train")
    pass
