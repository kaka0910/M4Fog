...
class Options():
    def __init__(self):
        ...
        parser.add_argument('--dataset', type=str, default='fy4a',
        ...
        # evaluation option
        parser.add_argument('--split', default='val_2021')
        ...
        parser.add_argument('--data_root', default='/groups/lmm2024/home/share/Sat_Pretrain_xmq/Data/FY4A_Data')
        parser.add_argument('--model_root', default='model')
        parser.add_argument('--vis_root', default='vis')

        # [xmq: model save folder]
        parser.add_argument('--model_savefolder', default='output')
        parser.add_argument('--pretrained', default="/groups/lmm2024/home/share/Sat_Pretrain_xmq/cloud_cs0502/FY4A_output_cs0506/")

        # [xmq: optim]
        parser.add_argument('--model_optimizer', default='SGD')
